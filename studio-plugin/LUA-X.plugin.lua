...
make<UIListLayout>("UIListLayout", {
	Padding = UDim.new(0, 9), SortOrder = Enum.SortOrder.LayoutOrder,
}, root)

make<TextLabel>("TextLabel", {
	Size = UDim2.new(1, 0, 0, 34), BackgroundTransparency = 1,
	Text = "LUA-X", Font = Enum.Font.GothamBold, TextSize = 25,
	TextColor3 = Color3.fromRGB(245, 247, 255), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 1,
}, root)
make<TextLabel>("TextLabel", {
	Size = UDim2.new(1, 0, 0, 38), BackgroundTransparency = 1,
	Text = "Understand → Plan → Review → Apply → Verify",
	Font = Enum.Font.Gotham, TextSize = 13, TextWrapped = true,
	TextColor3 = Color3.fromRGB(166, 173, 190), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 2,
}, root)

make<TextLabel>("TextLabel", {
	Size = UDim2.new(1, 0, 0, 20), BackgroundTransparency = 1,
	Text = "Backend endpoint", Font = Enum.Font.GothamMedium, TextSize = 12,
	TextColor3 = Color3.fromRGB(190, 197, 214), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 3,
}, root)
local endpointBox = make<TextBox>("TextBox", {
	Size = UDim2.new(1, 0, 0, 38), BackgroundColor3 = Color3.fromRGB(29, 32, 41),
	BorderSizePixel = 0, ClearTextOnFocus = false, Font = Enum.Font.Code, TextSize = 12,
	TextColor3 = Color3.fromRGB(232, 235, 245), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 4,
}, root)
...
local endpointControls = make<Frame>("Frame", {
	Size = UDim2.new(1, 0, 0, 34), BackgroundTransparency = 1, LayoutOrder = 5,
}, root)
make<UIListLayout>("UIListLayout", {
	FillDirection = Enum.FillDirection.Horizontal, Padding = UDim.new(0, 8),
	VerticalAlignment = Enum.VerticalAlignment.Center,
}, endpointControls)
local testConnectionButton = make<TextButton>("TextButton", {
	Size = UDim2.new(0.5, -4, 1, 0), BackgroundColor3 = Color3.fromRGB(39, 43, 54),
	BorderSizePixel = 0, Text = "Test Connection", Font = Enum.Font.GothamMedium,
	TextSize = 12, TextColor3 = Color3.fromRGB(235, 239, 250),
}, endpointControls)
local saveEndpointButton = make<TextButton>("TextButton", {
	Size = UDim2.new(0.5, -4, 1, 0), BackgroundColor3 = Color3.fromRGB(39, 43, 54),
	BorderSizePixel = 0, Text = "Save Endpoint", Font = Enum.Font.GothamMedium,
	TextSize = 12, TextColor3 = Color3.fromRGB(235, 239, 250),
}, endpointControls)

make<TextLabel>("TextLabel", {
	Size = UDim2.new(1, 0, 0, 20), BackgroundTransparency = 1,
	Text = "Describe the change", Font = Enum.Font.GothamMedium, TextSize = 12,
	TextColor3 = Color3.fromRGB(190, 197, 214), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 6,
}, root)
local promptBox = make<TextBox>("TextBox", {
	Size = UDim2.new(1, 0, 0, 112), BackgroundColor3 = Color3.fromRGB(29, 32, 41),
	BorderSizePixel = 0, ClearTextOnFocus = false, Font = Enum.Font.Gotham, TextSize = 13,
	TextColor3 = Color3.fromRGB(239, 242, 250),
	PlaceholderText = "Example: Add a sprint system to the selected controller with server validation.",
	TextWrapped = true, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Top,
	MultiLine = true, LayoutOrder = 7,
}, root)

local actionRow = make<Frame>("Frame", {
	Size = UDim2.new(1, 0, 0, 38), BackgroundTransparency = 1, LayoutOrder = 8,
}, root)
make<UIListLayout>("UIListLayout", {
	FillDirection = Enum.FillDirection.Horizontal, Padding = UDim.new(0, 8),
	VerticalAlignment = Enum.VerticalAlignment.Center,
}, actionRow)
local refreshButton = make<TextButton>("TextButton", {
	Size = UDim2.new(0.5, -4, 1, 0), BackgroundColor3 = Color3.fromRGB(39, 43, 54),
	BorderSizePixel = 0, Text = "Refresh Context", Font = Enum.Font.GothamMedium,
	TextSize = 13, TextColor3 = Color3.fromRGB(235, 239, 250),
}, actionRow)
local generateButton = make<TextButton>("TextButton", {
	Size = UDim2.new(0.5, -4, 1, 0), BackgroundColor3 = Color3.fromRGB(72, 92, 255),
	BorderSizePixel = 0, Text = "Generate Plan", Font = Enum.Font.GothamBold,
	TextSize = 13, TextColor3 = Color3.fromRGB(255, 255, 255),
}, actionRow)

local statusLabel = make<TextLabel>("TextLabel", {
	...
	TextColor3 = Color3.fromRGB(150, 158, 177), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 9,
}, root)

make<TextLabel>("TextLabel", {
	Size = UDim2.new(1, 0, 0, 20), BackgroundTransparency = 1,
	Text = "Studio Context", Font = Enum.Font.GothamBold, TextSize = 14,
	TextColor3 = Color3.fromRGB(238, 241, 249), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 10,
}, root)
local contextBox = make<TextBox>("TextBox", {
	Size = UDim2.new(1, 0, 0, 180), BackgroundColor3 = Color3.fromRGB(23, 26, 33),
	BorderSizePixel = 0, ClearTextOnFocus = false, Font = Enum.Font.Code, TextSize = 11,
	TextColor3 = Color3.fromRGB(201, 208, 223), Text = "No context loaded.",
	TextWrapped = true, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Top,
...
make<TextLabel>("TextLabel", {
	Size = UDim2.new(1, 0, 0, 20), BackgroundTransparency = 1,
	Text = "Plan Preview", Font = Enum.Font.GothamBold, TextSize = 14,
	TextColor3 = Color3.fromRGB(238, 241, 249), TextXAlignment = Enum.TextXAlignment.Left,
	LayoutOrder = 12,
}, root)
local planBox = make<TextBox>("TextBox", {
	Size = UDim2.new(1, 0, 0, 300), BackgroundColor3 = Color3.fromRGB(23, 26, 33),
	BorderSizePixel = 0, ClearTextOnFocus = false, Font = Enum.Font.Code, TextSize = 11,
	TextColor3 = Color3.fromRGB(209, 216, 233), Text = "No plan yet.",
	TextWrapped = true, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Top,
	MultiLine = true, LayoutOrder = 13,
}, root)

local applyButton = make<TextButton>("TextButton", {
	Size = UDim2.new(1, 0, 0, 44), BackgroundColor3 = Color3.fromRGB(43, 154, 91),
	BorderSizePixel = 0, Text = "Apply Script Changes", Font = Enum.Font.GothamBold,
	TextSize = 13, TextColor3 = Color3.fromRGB(255, 255, 255), LayoutOrder = 14,
}, root)
local verifyButton = make<TextButton>("TextButton", {
	Size = UDim2.new(1, 0, 0, 38), BackgroundColor3 = Color3.fromRGB(39, 43, 54),
	BorderSizePixel = 0, Text = "Run Local Verification", Font = Enum.Font.GothamMedium,
	TextSize = 13, TextColor3 = Color3.fromRGB(235, 239, 250), LayoutOrder = 15,
}, root)
...
local function setStatus(text: string, state: string?)
	...
	statusLabel.TextColor3 = if state == "good" then Color3.fromRGB(109, 215, 143)
		elseif state == "bad" then Color3.fromRGB(246, 122, 122)
		else Color3.fromRGB(150, 158, 177)
end
...
local function refreshContext()
	...
	for _, scriptObject in ipairs(scripts) do
		...
		if source then
			table.insert(snippets, "-- " .. pathOf(scriptObject) .. "\n" .. trim(source, MAX_SOURCE_PER_SCRIPT))
		end
	end
	...
	selectedContext = {
		...
		constraints = {
			"Roblox Studio context was collected from the current selection.",
			"Provider credentials must never be placed in generated Studio code.",
			"Prefer minimal, reversible, reviewable changes.",
			"Never claim Studio tests passed unless this plugin produced the evidence.",
		},
	}
	...
	local rendered = {
		...
		"",
		"Instances:",
		if #instances > 0 then table.concat(instances, "\n") else "(none)",
	}
	if #files > 0 then
		table.insert(rendered, "")
		table.insert(rendered, "Scripts:")
		table.insert(rendered, table.concat(files, "\n"))
	end
	if architecture ~= "" then
		table.insert(rendered, "")
		table.insert(rendered, "Source context:")
		table.insert(rendered, architecture)
	end
...
local function testConnection()
	...
	local ok, response = pcall(function()
		return HttpService:RequestAsync({
			Url = healthEndpoint(generateUrl),
			Method = "GET",
	...
	requestBusy = false
	if not ok then
		setStatus("Connection failed. Enable HTTP Requests and check the endpoint. " .. tostring(response), "bad")
		return
	end
	if not response.Success then
		setStatus("Backend " .. tostring(response.StatusCode) .. ": " .. trim(response.Body or response.StatusMessage or "unknown error", 260), "bad")
		return
	end
	local parsedOk, parsed = pcall(function() return HttpService:JSONDecode(response.Body) end)
	if not parsedOk or typeof(parsed) ~= "table" then
		setStatus("Backend responded, but the health payload was invalid.", "bad")
		return
	end
...
local function generatePlan()
	...
	local api = saveConfiguredEndpoint()
	refreshContext()
	setStatus("LUA-X is compiling project context and generating a plan…")
	...
	if not ok then
		setStatus("Request failed: " .. tostring(response), "bad")
		return
	end
	if not response.Success then
		setStatus("API " .. tostring(response.StatusCode) .. ": " .. trim(response.Body or response.StatusMessage or "unknown error", 320), "bad")
		return
	end
	...
	if decoded.error ~= nil then
		setStatus("LUA-X: " .. tostring(decoded.error), "bad")
		return
	end
	if typeof(decoded.plan) ~= "table" or typeof(decoded.plan.changes) ~= "table" then
		setStatus("LUA-X returned a plan without a valid change list.", "bad")
		return
	end

	currentPlan = decoded.plan
	planBox.Text = HttpService:JSONEncode(decoded.plan)
...
local function applyProposal(proposal: {[string]: any}): (boolean, string)
	...
	if operation ~= "update_script" and operation ~= "create_script" then
		return false, "deferred operation: " .. operation
	end
...
local function applyPlan()
	...
	if applicable == 0 then
		setStatus("This plan contains no automatically applicable script changes.")
		return
	end

	if not applyArmed then
		applyArmed = true
		applyButton.Text = string.format("Confirm Apply (%d script change(s))", applicable)
		setStatus(string.format("Review the plan carefully. Click Apply again to make %d Studio change(s).", applicable))
		return
	end
	...
	if failed == 0 then
		setStatus(string.format("Applied %d change(s) successfully. %d deferred operation(s) were left untouched.", successful, deferred), "good")
	else
		setStatus(string.format("Applied %d, failed %d, deferred %d. Studio Undo can revert the completed edits.", successful, failed, deferred), "bad")
	end
end
...
local function runLocalVerification()
	...
	if typeof(currentPlan) == "table" and typeof(currentPlan.changes) == "table" then
		table.insert(checks, "Plan changes: " .. tostring(#currentPlan.changes))
		local applicable = 0
		for _, proposal in ipairs(currentPlan.changes) do
			if typeof(proposal) == "table" and (proposal.operation == "update_script" or proposal.operation == "create_script") then
				applicable += 1
		...
		table.insert(checks, "Plan present: no")
	end
	local scriptCount = 0
	for _, item in ipairs(selection) do
		if item:IsA("LuaSourceContainer") then scriptCount += 1 end
		for _, descendant in ipairs(item:GetDescendants()) do
			if descendant:IsA("LuaSourceContainer") then scriptCount += 1 end
		end
	end
	table.insert(checks, "Selected script containers: " .. tostring(scriptCount))
	table.insert(checks, "Endpoint: " .. normalizeEndpoint(endpointBox.Text))
	table.insert(checks, "HTTP access: requires Studio HTTP Requests permission")
	planBox.Text = table.concat(checks, "\n")
	setStatus("Plugin-side verification complete. This does not claim that your game passes runtime playtests.", "good")
end

Selection.SelectionChanged:Connect(function()
	if widget.Enabled then refreshContext() end
end)

testConnectionButton.MouseButton1Click:Connect(testConnection)
saveEndpointButton.MouseButton1Click:Connect(function()
	saveConfiguredEndpoint()
	setStatus("Endpoint saved for this plugin installation.", "good")
end)
